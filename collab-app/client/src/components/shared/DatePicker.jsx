...
const styles = {
    ...
    monthLabel: {
        fontSize: 13, fontWeight: 700, color: 'var(--text)', fontFamily: 'monospace',
    },
    grid: {
        display: 'grid', gridTemplateColumns: 'repeat(7, 1fr)', gap: 2,
    },
    dayName: {
        fontSize: 9, color: 'var(--textDim)', textAlign: 'center',
    ...
    selected: {
        background: '#00E5C3', color: 'var(--bg)', fontWeight: 700,
    },
    today: {
