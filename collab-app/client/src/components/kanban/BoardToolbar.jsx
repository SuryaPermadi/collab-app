        ...
        <div style={styles.wrap}>
            ...
            <div style={{ position: 'relative' }}>
                <button
                    style={{
                        ...styles.btn,
                        borderColor: hasActiveFilter ? '#7B61FF' : 'var(--border)',
                        color: hasActiveFilter ? '#7B61FF' : 'var(--textMuted)',
                    ...
                    <div style={styles.filterDropdown}>
                            ...
                            <div style={styles.priorityGroup}>
                                {PRIORITIES.map(p => (
                                    <button
                                        ...
                                        style={{
                                            ...styles.priorityChip,
                                            borderColor: filters.priority === p ? PRIORITY_COLORS[p] : 'var(--border)',
                                            color: filters.priority === p ? PRIORITY_COLORS[p] : 'var(--textMuted)',
                        ...
                        <div style={styles.filterSection}>
                            ...
                            <button
                                style={{
                                    ...styles.dueSoonBtn,
                                    borderColor: filters.dueSoon ? '#FFB347' : 'var(--border)',
                                    color: filters.dueSoon ? '#FFB347' : 'var(--textMuted)',
...
const styles = {
    ...
    btn: {
        ...
        color: 'var(--textMuted)', padding: '6px 14px', cursor: 'pointer',
    ...
    filterLabel: {
        fontSize: 10, color: 'var(--textDim)', fontFamily: 'monospace',
    ...
    clearAllBtn: {
        ...
        color: 'var(--textMuted)', cursor: 'pointer', fontSize: 11,
