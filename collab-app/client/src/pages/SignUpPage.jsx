        ...
        <div style={styles.page}>
            <div style={styles.left}>
                <div style={styles.brand}>
                    ...
                    <p style={styles.tagline}>Mulai kolaborasi real-time bersama tim kamu</p>
                </div>
...
const styles = {
    ...
    logo: { fontSize: 48, color: '#00E5C3', marginBottom: 16, lineHeight: 1 },
    title: {
        fontSize: 36, fontWeight: 800, color: '#E6EDF3',
        margin: '0 0 8px', letterSpacing: '-0.5px',
    },
    tagline: { fontSize: 16, color: '#8B949E', margin: 0, lineHeight: 1.5 },
    ...
    featureLabel: { fontSize: 15, color: '#C9D1D9', fontWeight: 500 },
    dots: {
        position: 'absolute', bottom: 40, right: 40,
        display: 'flex', gap: 8, alignItems: 'flex-end',
    },
    dot: { background: '#00E5C3', borderRadius: '50%' },
    right: {
        width: 480, display: 'flex', alignItems: 'center',
        justifyContent: 'center', padding: '40px', background: '#080A0F',
    },
}