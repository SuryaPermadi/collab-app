...
const styles = {
  page: { minHeight: '100vh', background: '#080A0F', fontFamily: "'DM Sans', sans-serif" },
  header: {
    display: 'flex', justifyContent: 'space-between', alignItems: 'center',
    padding: '20px 48px', borderBottom: '1px solid #1E2433',
    position: 'sticky', top: 0, background: '#080A0F', zIndex: 10,
  },
  logo: { display: 'flex', alignItems: 'center', gap: 10 },
  logoText: { fontFamily: 'monospace', fontSize: 16, fontWeight: 700, color: '#E8EBF2' },
  ...
  userName: { fontSize: 14, color: '#E8EBF2' },
  logoutBtn: {
    background: 'none', border: '1px solid #1E2433', color: '#5A6380',
  ...
  pageTitle: { fontSize: 28, fontWeight: 800, color: '#E8EBF2' },
  ...
  btnOutline: {
    background: 'none', color: '#E8EBF2', border: '1px solid #1E2433',
  ...
  roleTag: {
    fontSize: 10, fontFamily: 'monospace', color: '#5A6380',
    background: '#1E2433', padding: '3px 8px', letterSpacing: '0.1em',
  },
  cardTitle: { fontSize: 18, fontWeight: 700, color: '#E8EBF2', marginBottom: 12 },
  cardMeta: { display: 'flex', justifyContent: 'space-between', fontSize: 12, color: '#5A6380' },
  inviteCode: { fontFamily: 'monospace', color: '#00E5C3' },
  empty: { textAlign: 'center', color: '#5A6380', padding: '100px 0', fontSize: 15, lineHeight: 1.8 },
  modal: {
    position: 'fixed', inset: 0, background: 'rgba(0,0,0,0.7)',
    display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 100,
  },
  modalBox: { background: '#0F1420', border: '1px solid #1E2433', padding: 40, width: 380 },
  modalTitle: { fontSize: 18, fontWeight: 700, color: '#E8EBF2', marginBottom: 20 },
  input: {
    width: '100%', background: '#080A0F', border: '1px solid #1E2433',
    color: '#E8EBF2', padding: '12px 14px', fontSize: 14, outline: 'none',
